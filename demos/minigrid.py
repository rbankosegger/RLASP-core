...
#builder = GymMinigridBuilder('MiniGrid-KeyCorridorS4R3-v0')
#builder = GymMinigridBuilder('MiniGrid-KeyCorridorS6R3-v0')
...
#builder = GymMinigridBuilder('MiniGrid-ObstructedMaze-1Dl-v0')
#builder = GymMinigridBuilder('MiniGrid-ObstructedMaze-Full-v0')
...
def fill(x, y, color, alpha):
    global tile_size
    rect = patches.Rectangle((x*tile_size, y*tile_size), tile_size, tile_size, linewidth=1, facecolor=color, alpha=alpha)

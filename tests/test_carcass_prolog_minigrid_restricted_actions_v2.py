...
from mdp.abstraction import PrologCarcass
...
class TestGymMinigrid(unittest.TestCase):
    ...
    def test_gutter_state(self):
        ...
        desired_abstract_state = "carcass_gutter_custom_actions[forward,left,right]"
    
        mdp = GymMinigridCustomLevelBuilder(ascii_encoding=world).build_mdp()
        abstract_mdp = PrologCarcass(mdp, rules_filename='prolog_minigrid_restricted_actions_v2.pl')
    ...
    def test_final_state_after_reaching_goal(self):
        ...
        self.assertEqual('carcass_gutter_custom_actions[]', abstract_mdp.state)
    ...
    def test_what_happens_after_going_through_door(self):
        ...
        desired_abstract_state = "carcass_['facing(east)', 'objective_x_is(east)', 'objective_y_is(on_axis)', 'touching(door(closed))', 'in_gap(none)'][left,right,toggle]"
        self.assertEqual(desired_abstract_state, abstract_mdp.state)
    
        abstract_mdp.transition('toggle')

        desired_abstract_state = "carcass_['facing(east)', 'objective_x_is(east)', 'objective_y_is(on_axis)', 'touching(door(open))', 'in_gap(none)'][forward,left,right,toggle]"
        self.assertEqual(desired_abstract_state, abstract_mdp.state)
    ...
    def test_tie_break_preferring_nearer_goals_1(self):
    ...
    def test_tie_break_preferring_nearer_goals_2(self):
        ...
        desired_abstract_state = "carcass_['facing(south)', 'objective_x_is(east)', 'objective_y_is(on_axis)', 'touching(goal)', 'in_gap(none)'][forward,left,right]"
        self.assertEqual(desired_abstract_state, abstract_mdp.state)

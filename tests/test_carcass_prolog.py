...
class TestCarcassProlog(unittest.TestCase):
    ...
    def test_three_blocksworld_example(self):
        ...
        abstract_mdp = PrologCarcass(mdp, rules_filename='prolog_blocksworld_otterlo_example.pl')
    ...
    def test_three_blocksworld_example_alternative(self):
        ...
        abstract_mdp = PrologCarcass(mdp, 'prolog_blocksworld_otterlo_example_alt.pl')
    ...
    def test_gutter_action(self):
        ...
        self.assertEqual('carcass_gutter[random]', abstract_mdp.state)
        self.assertEqual({'random'}, abstract_mdp.available_actions)
        self.assertEqual({'move(b3,table)'}, abstract_mdp.ground_actions_of('random'))

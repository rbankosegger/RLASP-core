...
class TestGymMinigrid(unittest.TestCase):
    ...
    def test_state_transition(self):
        ...
        self.assertEqual(static_state | {'obj(agent(right),2,1)'},
                         next_state)
        ...
        next_state, next_reward = mdp.transition('forward')
        self.assertEqual(static_state | {'obj(agent(right),3,1)'},
                         next_state)
        self.assertEqual(0, next_reward)
        self.assertEqual(static_state | {'obj(agent(right),3,1)'},
                         mdp.state)
        ...
        self.assertEqual(static_state | {'obj(agent(down),3,1)'},
                         next_state)
        self.assertEqual(0, next_reward)
        self.assertEqual(static_state | {'obj(agent(down),3,1)'},
                         mdp.state)
        ...
        next_state, next_reward = mdp.transition('forward')
        self.assertEqual(static_state | {'obj(agent(down),3,2)'},
                         next_state)
        self.assertEqual(0, next_reward)
        self.assertEqual(static_state | {'obj(agent(down),3,2)'},
                         mdp.state)
        ...
        next_state, next_reward = mdp.transition('forward')
        self.assertEqual((static_state | {'obj(agent(down),3,3)'}) - {'obj(goal,3,3)'},
                         next_state)
        step_count = 6
        max_steps = 100.0
